...
<script>
	...
	function googleTranslateElementInit() {new google.translate.TranslateElement({pageLanguage: '${language}', includedLanguages : 'en,ja,es,ko'}, 'google_translate_element');}
