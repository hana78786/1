...
<body>
    ...
    <main>
    	<form action="/book/norSeriesRegist.do" method="post" enctype="multipart/form-data">
	        <section class="container">
	            <article>
	                ...
	                <div id="title-area">
	                    <div class="title-text">
							...
							<input type="hidden" name="bookNo" value="${nBook.bookNo}"> 
	                        <input type="text" id="title-text" value="${nBook.bookTitle }" readonly="readonly">
	                    </div>
	            ...
	            <article id="first-contents">
	                ...
	                <div class="contents-button row">
	                    ...
	                    <button class="col-6"> 등록 </button> <button class="col-6" type="button" onclick="location.href='/book/norBookInfo?bookNo=${nBook.bookNo}'"> 취소</button>
	                </div>
